...
//error 404
app.get('*', function (req, res) { return res.render('error404', { data: req.originalUrl }); });
// process.env.NODE_ENV.includes('prod') ? app.set('view cache', true) : app.set('view cache', false)
app.listen(port)
    .on('listening', function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, console.log("Listening at http://localhost:" + port)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
